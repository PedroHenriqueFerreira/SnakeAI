...
from snake_game.config import DARK_COLOR, FOOD_COLOR
...
class UI:
    ...
    def draw_layer(
        ...
        vertical_size = NEURON_SIZE * layer_size + \
            NEURON_VERTICAL_MARGIN * (layer_size - 1)
        ...
        for neuron_idx, neuron in enumerate(layer.neurons):
            ...
            neuron_color = FOOD_COLOR if neuron.output > 0 else DARK_COLOR
            ...
            if layer_idx == 0 or prev_layer is None or neuron.wheights is None: continue
            ...
            for i, element in enumerate(neural_elements[-1]):
                ...
                line_color = FOOD_COLOR if output > 0 and neuron.output > 0 else DARK_COLOR
    ...
    def draw_neural_network(canvas: Canvas, neural_network):
        ...
        horizontal_size = NEURON_SIZE * layers_size + \
            NEURON_HORIZONTAL_MARGIN * (layers_size - 1)
        ...
        for layer_idx, layer in enumerate(layers):
            ...
            UI.draw_layer(canvas, layer, prev_layer, layer_idx,
                          left, neural_elements, text_elements)
